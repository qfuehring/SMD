...
# nur zum Vergleich von sklearn und scipy.optimize.curve_fit
def lin(x, m, b):
    return m*x+b
...
plt.hist(np.abs(Train['SalePrice']-Train['OverallQual']/m[0]-b/m[0]))
plt.savefig('Diff.png')
plt.close()

#d) sehr rudimentär mit der Regression von b
#schöner aber immer noch rudimentär: gewichtetes mittel der Regression durch die 3besten Attribute

a = np.asarray([Test['Id'],Test['OverallQual'],Test['OverallQual']/m[0]-b/m[0]])
np.savetxt("foo.csv", a.T, delimiter=",") #das abel der Attribute fehlt
