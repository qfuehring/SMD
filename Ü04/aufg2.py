...
def proj():
    ...
    ax_1.hist(x_P0_0,bins=50, label=r"$P_0$")
    ax_1.hist(x_P1_0,bins=50, label=r"$P_1$")
    ax_1.legend(loc='best')
    ax_2.hist(x_P0_1,bins=50, label=r"$P_0$")
    ax_2.hist(x_P1_1,bins=50, label=r"$P_1$")
    ax_2.legend(loc='best')
    ax_3.hist(x_P0_2,bins=50, label=r"$P_0$")
    ax_3.hist(x_P1_2,bins=50, label=r"$P_1$")
